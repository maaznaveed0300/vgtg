                        ...
                        <tbody>
                            ...
                            {{-- @if ($ab->image!=null) --}}
                                <tr>
                                    ...
                                    <td>
                                        {{-- <a href="{{ url('approve/'.$a->id) }}" type="submit"><button class="btn btn-primary">{{$a->status==1?"Reject":"Approve"}}</button></a><br><br><br>
                                        <a href="{{ url('reject/'.$a->id) }}" type="submit"><button class="btn btn-primary">{{$a->status==2?"Approve":"Reject"}}</button></a> --}}
